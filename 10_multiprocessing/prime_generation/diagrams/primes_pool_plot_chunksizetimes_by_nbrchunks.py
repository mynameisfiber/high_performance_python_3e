...
if __name__ == "__main__":
    ...
    png_filename = "09_primes_pool_plot_chunksizetimes_by_nbrchunks_sawtoothpattern{}.png".format(shuffle_in_filename)
    ...
    if args.create_data:
        ...
        pickle.dump((nbr_chunks_per_trial, time_per_chunksize, NBR_PROCESSES, number_range), open(filename, 'wb'))
    else:
        nbr_chunks_per_trial, time_per_chunksize, NBR_PROCESSES, number_range = pickle.load(open(filename, 'rb'))
        ...
        plt.tight_layout()
        print(f"Writing to {png_filename=}")
