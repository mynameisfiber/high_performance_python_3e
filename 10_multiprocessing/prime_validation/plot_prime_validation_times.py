...
times_primes = [0.000001, 2.5, 4.5, 8.3, 8.3] # primes.py
times_primes_pool_per_number2 = [0.000001, 1.07, 1.05, 1.05, 1.06] # primes_pool_per_number2.py
times_primes_pool_per_number_redis = [0.00008, 1.16, 0.95, 3.16, 3.07] # primes_pool_per_number_redis.py
times_primes_pool_per_number_manager = [0.000054, 2.25, 1.87, 5.6, 5.6] # primes_pool_per_number_manager.py

times_primes_pool_per_number_value = [0.000001, 0.63, 0.50, 1.55, 1.55] # primes_pool_per_number_value.py
times_primes_pool_per_number_mmap = [0.000001, 0.61, 0.52, 1.57, 1.57] # primes_pool_per_number_mmap.py
times_primes_pool_per_number_mmap3 = [0.000001, 0.43, 0.35, 1.06, 1.06] # primes_pool_per_number_mmap3.py
...
for times, label, symbol, linestyle in zip(all_times, method_labels, symbols, linestyles):
    ...
    plt.plot(list(range(len(labels))), times, label=label, marker=symbol, linestyle=linestyle, markersize=10)
