...
if __name__ == "__main__":
    ...
    #words_trie = lexpy.Trie()
    words_trie = lexpy.DAWG()
    t1 = time.time()
    # note that a DAWG in lexpy needs the input to be sorted
    words_trie.add_all(readers)
    words_trie.reduce() # for DAWG compaction
    t2 = time.time()
    ...
    print(f"The trie contains {words_trie.get_word_count()} words")
